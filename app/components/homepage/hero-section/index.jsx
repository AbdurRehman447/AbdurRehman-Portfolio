          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-500">{`'`}</span>
                <span className="text-amber-300">AbdurRehman</span>
                <span className="text-gray-500">{`',`}</span>
              </div>
              ...
              <div>
                <span className="ml-8 lg:ml-16 mr-2 text-orange-500">return</span>
                <span className="text-gray-500">{`(`}</span>
              </div>
              <div>
              ...
              <div><span className="ml-8 lg:ml-16 mr-2 text-gray-500">{`);`}</span></div>
              <div><span className="ml-4 lg:ml-8 text-gray-500">{`};`}</span></div>
